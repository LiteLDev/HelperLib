...
declare namespace mc {
  ...
  /** 玩家重生 */
  function listen(event: 'onRespawn', listener: (player: Player) => void): boolean
  ...
  /** 玩家正在吃食物 */
  function listen(event: 'onEat', listener: (player: Player) => boolean | void): boolean
  ...
  function listen(
    ...
    listener: (player: Player, slotNum: number, oldItem: Item, newItem: Item) => void,
  ): boolean
