declare class data {
   ...
   */
  static toJson(_var: any, space: number): string | null;
   ...
   */
  static toMD5(str: string | ArrayBuffer): string;
   ...
   */
  static toSHA1(str: string | ArrayBuffer): string;
   ...
   */
  static toBase64(str: string | ArrayBuffer): string;
   ...
   */
  static fromBase64(base64: string, isBinary: boolean): string | ArrayBuffer;
}
